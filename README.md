...
To build the project from source, see the [Building and Testing documentation](https://github.com/synhershko/Spatial4n/blob/master/docs/building-and-testing.md).
